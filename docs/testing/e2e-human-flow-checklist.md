...
5. 在文件树打开 `chapters/vol-01/ch-001/sec-001.md`。
...
- `workspace/projects/{projectId}/chapters/vol-01/ch-001/sec-001.md`
...
## 6. 专业模式：polish / rewrite candidate 闭环
