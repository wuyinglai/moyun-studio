...
class CandidateService:
    ...
    async def get_candidate(self, project_id: str, candidate_id: str) -> Optional[CandidateInfo]:
        """获取候选稿信息"""
        metadata = await self._load_metadata(project_id)
    ...
    async def get_candidate_content(self, project_id: str, candidate_id: str) -> Optional[str]:
        """获取候选稿内容"""
    ...
    async def list_candidates(self, project_id: str, status: Optional[CandidateStatus] = None) -> List[CandidateInfo]:
        """列出候选稿"""
        metadata = await self._load_metadata(project_id)
