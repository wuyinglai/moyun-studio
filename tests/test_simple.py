...
# 读取工具定义并执�?with open(r'c:\\Users\\wuyin\\.trae-cn\\mcps\\s_newmoyun-19eef4df\\solo_agent_lite\\integrated_browser\\tools\\{tool}.json', 'r') as f:
...
def main():
    ...
    # 检查前端是否运�?    try:
        ...
        print(f"�?前端运行�?(状态码: {response.status})")
    ...
    print("\n测试项目:")
    print("  1. M01 顶部工具�?(Logo、项目名称、LLM状态、按�?")
    print("  2. M02 左侧文件�?(标题栏、文件夹、文件项)")
    print("  3. M03 中间编辑器区 (标签页、工具栏、编辑区、聊天区)")
    print("  4. M04 右侧面板 (Prompt面板、执行面�?")
    print("  5. M05 模态框 (新建项目、打开项目、设�?")
    print("  6. M06 通知系统")
    print("  7. M07 拖拽调整")
    print("  8. M08 主题系统")
    
    print("\n详细测试脚本已创�? tests/test_moyun_features.py")
