...
端点：
  GET    /api/snapshots/{project_id}          获取文件的快照列表
  POST   /api/snapshots/{project_id}          创建版本快照
  POST   /api/snapshots/{project_id}/restore  恢复指定快照
"""
