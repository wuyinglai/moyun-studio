...
class PipelineContext(BaseModel):
    ...
    output_mode: str = Field("write_scene", description="输出模式：write_scene/candidate/append (LEGACY_COMPAT: overwrite accepted but deprecated)")  # AI_GUARDRAIL_ALLOW: schema definition with LEGACY_COMPAT note
